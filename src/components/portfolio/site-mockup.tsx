...
export function SiteMockup({
  ...
  return (
    <div className={cn("relative flex aspect-4/3 flex-col overflow-hidden rounded-2xl border border-border bg-white transition-all duration-300 group-hover:-translate-y-1 group-hover:border-accent/40 group-hover:shadow-xl group-hover:shadow-primary/5", className)}>
